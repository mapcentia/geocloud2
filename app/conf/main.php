...
set_include_path(get_include_path().PATH_SEPARATOR.$basePath."app".PATH_SEPARATOR.$basePath."libs".PATH_SEPARATOR.$basePath."inc".PATH_SEPARATOR.$basePath."libs/PEAR/".PATH_SEPARATOR.$basePath."conf");
