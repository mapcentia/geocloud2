<?php
// Join on table and schema. Not geometry column
$sqls[] = "CREATE VIEW settings.geometry_columns_view AS
                      ...
                      FROM raster_columns
                        LEFT JOIN
                        settings.geometry_columns_join ON geometry_columns_join._key_ =
                                                         raster_columns.r_table_schema || '.' || raster_columns.r_table_name
                      ...
                      FROM non_postgis_matviews
                        LEFT JOIN
                        settings.geometry_columns_join ON geometry_columns_join._key_ =
                                                         non_postgis_matviews.f_table_schema || '.' || non_postgis_matviews.f_table_name
