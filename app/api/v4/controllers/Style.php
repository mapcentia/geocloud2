...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: "opacity", title: "Opacity", description: "Opacity of this style, from 0 (fully transparent) to 100 (fully opaque). Maps to STYLE OPACITY. Numeric value stored as a string.", type: "string", example: "100"),
        ...
        new OA\Property(property: "offsetx", title: "Offset X", description: "Horizontal geometry offset in layer SIZEUNITS (usually pixels); may reference a [column]. Maps to the X component of STYLE OFFSET. Numeric value stored as a string.", type: "string", example: "0"),
        new OA\Property(property: "offsety", title: "Offset Y", description: "Vertical geometry offset in layer SIZEUNITS (usually pixels); may reference a [column]. Maps to the Y component of STYLE OFFSET. Numeric value stored as a string.", type: "string", example: "0"),
        new OA\Property(property: "polaroffsetr", title: "Polar offset radius", description: "Radius/distance component of a polar-coordinate offset. Maps to the radius component of STYLE POLAROFFSET. Numeric value stored as a string.", type: "string", example: "0"),
        new OA\Property(property: "polaroffsetd", title: "Polar offset angle", description: "Angle (counter-clockwise), in degrees, component of a polar-coordinate offset. Maps to the angle component of STYLE POLAROFFSET. Numeric value stored as a string.", type: "string", example: "0"),
    ],
    type: "object"
)]
