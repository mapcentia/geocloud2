...
Ext.onReady(function() {
	...
	$.ajax({
		url: '/controller/tables/' + screenName + '/getcolumns/' + getvars['layer'],
		async: false,
		dataType: 'json',
		type: 'GET',
			...
			if (http.readyState == 4) {
				if (http.status == 200) {
					...
					for (var i in columnsForGrid) {
						...
						//alert(columnsForGrid[i].header+" "+columnsForGrid[i].typeObj.type);
	...
	var saveStrategy = new OpenLayers.Strategy.Save({
		onCommit: function(response) {
			...
			try {var inserted = doc.getElementsByTagName('wfs:totalInserted')[0].firstChild.data} catch(e){};
			try {var deleted = doc.getElementsByTagName('wfs:totalDeleted')[0].firstChild.data} catch(e){};
			try {var updated = doc.getElementsByTagName('wfs:totalUpdated')[0].firstChild.data} catch(e){};
			try {var updated = doc.getElementsByTagName('wfs:Message')[0].firstChild.data} catch(e){};
			
			// For webkit
			try {var inserted = doc.getElementsByTagName('totalInserted')[0].firstChild.data} catch(e){};
			try {var deleted = doc.getElementsByTagName('totalDeleted')[0].firstChild.data} catch(e){};
			try {var updated = doc.getElementsByTagName('totalUpdated')[0].firstChild.data} catch(e){};
			try {var updated = doc.getElementsByTagName('Message')[0].firstChild.data} catch(e){};
			...
			//message+="<textarea rows='5' cols='31'>"+error+"</textarea>"
		   ...
		   format =  new OpenLayers.Format.XML();
			var doc = format.read(response.priv.responseText);
			try {
				var error = doc.getElementsByTagName('ServiceException')[0].firstChild.data} catch(e){};
			try {
				var error = doc.getElementsByTagName('wfs:ServiceException')[0].firstChild.data} catch(e){};
...
/*loadMessage.show({
msg: 'Getting your data, please wait...',
