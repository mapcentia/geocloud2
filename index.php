...
<head>
    ...
    <meta name="description"
          content="Visualize your data on maps. Just use HTML and JavaScript through a powerful API for adding maps to your own app or web site"/>
    <meta name="description"
          content="The core component of MyGeoCloud is the rock solid PostGIS database with endless possibilities. If you can think the analysis you can do it."/>
    <meta name="description"
          content="With a powerful adminstration tool you can manage your data online. Get full control from every where."/>
    <meta name="keywords"
        ...
        <div class="marketing">
            <div class="row">
                <div class="span4">
                    <div>
                        ...
                        <p>
                            Visualize your data on maps. Just use HTML and JavaScript through a powerful API for adding
                            maps to your own app or web site. <a href="/developers/mapclientapi/index.html">Learn
                                more</a>.
                        </p>
                    </div>
                </div>
                <div class="span4">
                    <div>
                        ...
                        <p>
                            The core component of MyGeoCloud is the rock solid PostGIS database with endless
                            possibilities. If you can think the analysis you can do it. <a
                                href="/developers/mapclientapi/advanced1.html">Learn more</a>.
                        </p>
                    </div>
                </div>
                <div class="span4">
                    <div>
                        ...
                        <p>
                            With a powerful adminstration tool you can manage your data online. Get full control from
                            every where.
                        </p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="span4">
                    ...
                    <p>
                        You can edit your data sets from any application, which supports the WFS-Tstandard. We recommend
                        the desktop application QGIS, which is OpenSource and runs on Linux, MacOSX and Windows.
                    </p>
                </div>
                <div class="span4">
                    ...
                    <p>
                        Upload your existing data to your MyGeoCloud database. At the moment you can upload Shape files
                        and MapInfo Tab files, but soon we will add more like GeoJSON og GML.
                    </p>
                </div>
                <div class="span4">
                    ...
                    <p>
                        With the SQL API you can fire any SQL query for accessing your data. You can use the API on web
                        sites, in apps and on servers. And in any programming language. <a
                            href="/developers/sqlapi/index.html">Learn more</a>
                    </p>
                </div>
            </div>
            <div class="row">
