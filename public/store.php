            ...
            <tr>
                <td>
                    <input type="text" readonly="readonly"
                           value="<?php \app\conf\App::$param['protocol'] ? : "http" ?>://<?php echo $_SERVER['HTTP_HOST']; ?>/wfs/<?php echo ($_SESSION['subuser']?$_SESSION['subuser']."@":"") . $_SESSION['screen_name']; ?>/<?php echo (\app\inc\Input::getPath()->part(3)) ? \app\inc\Input::getPath()->part(3) : "public"; ?>/4326"
                           size="65"/>
                </td>
            </tr>
            </tbody>
    ...
    <div id="wms-dialog">
        <table border="0">
            ...
            <tr>
                <td>
                    <input type="text" readonly="readonly"
                           value="<?php \app\conf\App::$param['protocol'] ? : "http" ?>://<?php echo $_SERVER['HTTP_HOST']; ?>/wms/<?php echo ($_SESSION['subuser']?$_SESSION['subuser']."@":"") . $_SESSION['screen_name']; ?>/<?php echo (\app\inc\Input::getPath()->part(3)) ? \app\inc\Input::getPath()->part(3) : "public"; ?>/"
                           size="65"/>
                </td>
            </tr>
            </tbody>
