    ...
    cartomobile.proxy = new Ext.data.HttpProxy(
        {
            restful: true,
            api: {
                read: '/controllers/layer/cartomobile/' + record.get("_key_"),
                update: '/controllers/layer/cartomobile/' + record.get("f_table_schema") + '.' + record.get("f_table_name") + '/' + record.get("_key_")
            },
            listeners: {
