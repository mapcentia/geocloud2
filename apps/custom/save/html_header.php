...
<html >
  <head>
	...
	<link rel="stylesheet" href="http://www.rudersdal.dk/layouts/css/global.css">
	<style>
	td.content-cell {border-top:1px solid #dddddd;padding:5px 20px 5px 5px;font-size:80%;vertical-align:text-top;text-align:left}
