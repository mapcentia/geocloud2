...
<body>
<div id="outercontentalign">
        <div id="outercontentshadowbottom">
            <div id="outercontentshadow">
                <div id="outercontentline">
                    <div id="outercontentwidth">
						<div style="position: relative;" id="logobar">

    <div><img width="960" height="98" usemap="#logoimagemap" alt="Rudersdal Kommune" src="http://www.rudersdal.dk/layouts/images/logoimage.gif"><map id="logoimagemap" name="logoimagemap"><area href="http://www.rudersdal.dk" coords="0,98, 0,0, 960,0, 960,69, 686,69, 642,98" title="Rudersdal Kommune - til forsiden" alt="Rudersdal Kommune - til forsiden" shape="poly"></map></div>
</div>
...
if (!$arr['vcUserName']) {
	...
	//echo $query;
	//echo "<a target='blank' href='/dk/kulturmiljoe/rudersdal_indtastning.htm?iFormID=113320001074440&rowid={$row['irowid']}'>Ret i posten</a>";
}
...
echo "<table><tr>";
echo "<td valign='top'><div style='border:0px solid silver;'><table border='0' cellpadding='3' cellspacing='0' width='500'>";
