...
if ($_GET['request']=="status") {?>
	...
	if ($row['status']=='forslag') {
		...
		<div>&nbsp;</div>
		<div>Giv din mening til kende! <a target="_blank" href="http://ltk-lp.cowi.webhouse.dk/dk/portalforside/hoering.htm?plannr=<?php echo $plannr ?>">Klik her</div>
		<?php }
			else {?>
